...
from inference.grasp_proposal.network_models.functions.gather_knn import gather_knn
#from tdgpd.nn.modules import *
from inference.grasp_proposal.network_models.nn_utils.modules import *
